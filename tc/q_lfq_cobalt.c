...
struct lfq_cobalt_preset {
	char *name;
	unsigned int target;
	unsigned int interval;
};

static struct lfq_cobalt_preset presets[] = {
	{"datacentre",		5,		100},
	{"lan",			50,		1000},
	{"metro",		500,		10000},
	{"regional",		1500,		30000},
...
static struct lfq_cobalt_preset *find_preset(char *argv)
{
	int i;
...
static void lfq_cobalt_print_mode(unsigned int value, unsigned int max,
...
struct qdisc_util lfq_cobalt_qdisc_util = {
	.id		= "lfq_cobalt",
	.parse_qopt	= lfq_cobalt_parse_opt,
	.print_qopt	= lfq_cobalt_print_opt,
	.print_xstats	= lfq_cobalt_print_xstats,
};
